...
class YdhPage(BasePage):
    ...
    def process_single_ydh_failed(self, ydh):
        ...
        try:
            ...
            ydh_elem.click()
            time.sleep(0.1)
            ydh_elem.send_keys(Keys.CONTROL, 'a')
            ydh_elem.send_keys(Keys.DELETE)
            time.sleep(0.2)
            ...
            if mobile_elem.get_attribute("value"):
                mobile_elem.click()
                time.sleep(0.1)
                mobile_elem.send_keys(Keys.CONTROL, 'a')
                mobile_elem.send_keys(Keys.DELETE)
                time.sleep(0.2)
